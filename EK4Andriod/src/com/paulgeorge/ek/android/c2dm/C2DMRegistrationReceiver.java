package com.paulgeorge.ek.android.c2dm;
...
import com.paulgeorge.ek.C2DMClientActivity;
import com.paulgeorge.ek.RegistrationResultActivity;
...
public class C2DMRegistrationReceiver extends BroadcastReceiver {
	...
	public void sendRegistrationIdToServer(String deviceId, String registrationId) {
		...
		//TODO Must create subdomain on BlueHost(c2dm) and register new URL on Heroku (c2dm.paulgeorge.com)
		//TODO Also must create register action in Play! EyeKeeper application
		HttpPost post = new HttpPost("http://c2dm.paulgeorge.com/register");
		try {
